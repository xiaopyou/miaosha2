...
//
//@Configuration
//public class MyRabbitMQConfig {//配置队列和交换器 如果自己已经配置了消息就不要在写了
//    private static final String duil ="miaosha2";
//    private static final String duil2 ="miaosha2s";
//private static final String jiaohj ="miaosha2.direct";
//    @Bean
